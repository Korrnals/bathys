...
Нативный режим клонирует SearXNG с официального GitHub по запиненному коммиту — его код не входит в пакет Bathys и лицензируется отдельно (AGPL-3.0). Условия и атрибуции — в [THIRD_PARTY_NOTICES.md](../../THIRD_PARTY_NOTICES.md).
