...
Живые сценарии «запрос → инструмент → профит» и пошаговый рецепт, как приучить харнесс работать с Bathys эффективно (субагент, скиллы, дроп-ин, сигналы футеров), — в [cases.md](cases.md), раздел C.
